...
CREATE TABLE "t_identity_source_provider" (
  ...
  "unique_id_attribute" varchar(255),
...
INSERT INTO "t_identity_source_provider" ("provider_id", "provider_name", "provider_code", "provider_desc", "provider_logo", "authorization_uri", "token_uri", "user_info_uris", "user_info_authentication_method", "username_attribute", "unique_id_attribute", "user_match_attribute", "jwk_set_uri", "issuer_uri", "meta_data", "create_time", "create_by", "update_time", "version", "deleted", "update_by", "scopes", "enable_custom_authz_req", "authz_req_cfg", "enable_custom_token_req", "token_req_cfg", "enable_custom_user_info_req", "user_info_req_cfg") VALUES ('bdc1e79f-156b-4f6f-8df3-44afc0ef2648', 'Github', 'github', 'GitHub 是一个面向开源及私有软件项目的托管平台。', 'https://files.authing.co/authing-console/social-connections/gitHub2.svg', 'https://github.com/login/oauth/authorize', 'https://github.com/login/oauth/access_token', 'https://api.github.com/user,https://api.github.com/user/emails', 'header', 'login', 'id', 'email', NULL, NULL, NULL, '2025-05-25 23:42:43.623468', 'admin', NULL, 1, 'f', NULL, 'read:user,user:email', 'f', NULL, 'f', NULL, 'f', NULL);
INSERT INTO "t_identity_source_provider" ("provider_id", "provider_name", "provider_code", "provider_desc", "provider_logo", "authorization_uri", "token_uri", "user_info_uris", "user_info_authentication_method", "username_attribute", "unique_id_attribute", "user_match_attribute", "jwk_set_uri", "issuer_uri", "meta_data", "create_time", "create_by", "update_time", "version", "deleted", "update_by", "scopes", "enable_custom_authz_req", "authz_req_cfg", "enable_custom_token_req", "token_req_cfg", "enable_custom_user_info_req", "user_info_req_cfg") VALUES ('5e66239e-2938-4747-915d-82a02740da25', '飞书', 'feishu', '飞书是先进企业协作与管理平台。', 'https://files.authing.co/authing-console/social-connections/feishu3.svg', 'https://accounts.feishu.cn/open-apis/authen/v1/authorize', 'https://open.feishu.cn/open-apis/authen/v2/oauth/token', 'https://open.feishu.cn/open-apis/authen/v1/user_info', 'header', 'name', 'union_id', 'email', NULL, NULL, NULL, '2025-05-31 00:57:24.009417', 'admin', NULL, 1, 'f', NULL, 'contact:user.email:readonly,contact:user.base:readonly', 'f', NULL, 'f', NULL, 'f', NULL);
INSERT INTO "t_identity_source_provider" ("provider_id", "provider_name", "provider_code", "provider_desc", "provider_logo", "authorization_uri", "token_uri", "user_info_uris", "user_info_authentication_method", "username_attribute", "unique_id_attribute", "user_match_attribute", "jwk_set_uri", "issuer_uri", "meta_data", "create_time", "create_by", "update_time", "version", "deleted", "update_by", "scopes", "enable_custom_authz_req", "authz_req_cfg", "enable_custom_token_req", "token_req_cfg", "enable_custom_user_info_req", "user_info_req_cfg") VALUES ('91a62c80-c722-4c85-93a5-963f2a3d8fe1', '华为', 'huawei', '华为是全球领先的计算机设备商，支持通过 HUAWEI 账号进行授权登录。', 'https://files.authing.co/authing-console/social-connections/huawei.svg', 'https://oauth-login.cloud.huawei.com/oauth2/v3/authorize', 'https://oauth-login.cloud.huawei.com/oauth2/v3/token', 'https://account.cloud.huawei.com/rest.php?nsp_svc=GOpen.User.getInfo', 'form', 'displayName', 'unionID', 'email', NULL, NULL, NULL, '2025-05-29 00:19:27.388046', 'admin', NULL, 1, 'f', NULL, 'email,profile', 'f', NULL, 'f', NULL, 'f', NULL);
INSERT INTO "t_identity_source_provider" ("provider_id", "provider_name", "provider_code", "provider_desc", "provider_logo", "authorization_uri", "token_uri", "user_info_uris", "user_info_authentication_method", "username_attribute", "unique_id_attribute", "user_match_attribute", "jwk_set_uri", "issuer_uri", "meta_data", "create_time", "create_by", "update_time", "version", "deleted", "update_by", "scopes", "enable_custom_authz_req", "authz_req_cfg", "enable_custom_token_req", "token_req_cfg", "enable_custom_user_info_req", "user_info_req_cfg") VALUES ('40d1590d-f870-45bb-ac51-0c4977f3b953', '钉钉', 'dingding', '钉钉是阿里巴巴出品，专为全球企业组织打造的智能移动办公平台。', 'https://files.authing.co/authing-console/social-connections/dingding2.svg', 'https://login.dingtalk.com/oauth2/auth', 'https://api.dingtalk.com/v1.0/oauth2/userAccessToken', 'https://api.dingtalk.com/v1.0/contact/users/me', 'header', 'nick', 'unionId', 'mobile', '', NULL, NULL, '2025-06-02 14:46:58.784075', 'admin', NULL, 1, 'f', NULL, 'openid,corpid', 't', '{
  "params" : {
...
-- ----------------------------
DELETE FROM "t_resource" WHERE "resource_id" = '97e86c03-4cea-4893-b78a-86d3af30cf0b';
DELETE FROM "t_resource" WHERE "resource_id" = 'd87ced98-de68-4242-a1c5-ac85ee5074d3';
...
-- ----------------------------
DELETE FROM "t_permission" WHERE "permission_id" = '2076e778-3003-4c37-9488-5c149016d306';
DELETE FROM "t_permission" WHERE "permission_id" = 'b720485d-3855-4523-bb75-b15e56231f56';
DELETE FROM "t_permission" WHERE "permission_id" = '439614ee-2e90-47cd-a25c-4cc7f18998c6';
DELETE FROM "t_permission" WHERE "permission_id" = '27859cf1-1d45-447b-b2d1-e39de70e159a';
DELETE FROM "t_permission" WHERE "permission_id" = '85e035cf-f642-4663-af44-5369e4dd9ec8';
DELETE FROM "t_permission" WHERE "permission_id" = 'dd756eed-c272-4492-af0d-171082f76733';
DELETE FROM "t_permission" WHERE "permission_id" = '50f5cef0-6b2e-47f2-a466-86f5ef3903b9';
DELETE FROM "t_permission" WHERE "permission_id" = 'cd742ce4-c32e-42f6-83c7-9e65342d2812';
DELETE FROM "t_permission" WHERE "permission_id" = 'bf9dca0a-86b2-4b07-896f-632d77259905';
DELETE FROM "t_permission" WHERE "permission_id" = 'aa057de2-e0e2-4554-8c2b-6c70d59472f0';
DELETE FROM "t_permission" WHERE "permission_id" = 'f2d07602-6337-43f7-bed5-e413e8ffe5a3';
DELETE FROM "t_permission" WHERE "permission_id" = 'fc7de197-3e11-4476-ad45-bdca6599ed34';
DELETE FROM "t_permission" WHERE "permission_id" = '8d0c0c81-81ae-4668-961b-aedce34e18cd';
DELETE FROM "t_permission" WHERE "permission_id" = 'bc11be5e-8ae9-43b4-888b-ac27eba9b6a9';
...
-- ----------------------------
DELETE FROM "t_authorize" WHERE "authorize_id" = '924e655c-ece7-46e1-a1e3-161a521b3f64';
DELETE FROM "t_authorize" WHERE "authorize_id" = 'fe6cfc55-3b16-4f1b-9664-0da8a938a798';
