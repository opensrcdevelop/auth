...
-- 35. t_tenant 表
-- ----------------------------
ALTER TABLE "t_tenant" DROP CONSTRAINT IF EXISTS "t_tenant_pkey";
ALTER TABLE "t_tenant" DROP COLUMN IF EXISTS "id";
DROP SEQUENCE IF EXISTS "t_tenant_id_seq" CASCADE;
