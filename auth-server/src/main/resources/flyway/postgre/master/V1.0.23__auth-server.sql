...
-- 1. 创建 WebAuthn 凭证表
-- ----------------------------
DROP TABLE IF EXISTS "t_webauthn_credential";
...
-- COMMENT
-- ----------------------------
COMMENT ON COLUMN t_webauthn_credential.id IS '主键';
...
COMMENT ON COLUMN t_webauthn_credential.public_key IS '公钥（JSON格式）';
