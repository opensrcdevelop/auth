...
public class UserGroupController {
    ...
    @PostMapping
    @PreAuthorize("@pms.hasAnyPermission('allUserGroupPermissions', 'createUserGroup')")
    ...
    @PostMapping("/mapping")
    @PreAuthorize("@pms.hasAnyPermission('allUserGroupMappingPermissions', 'createUserGroupMapping')")
    ...
    @GetMapping("/list")
    @PreAuthorize("@pms.hasAnyPermission('allUserGroupPermissions', 'listUserGroup')")
    ...
    @PreAuthorize("@pms.hasAnyPermission('allUserGroupMappingPermissions', 'deleteUserGroupMapping')")
    ...
    @GetMapping("/{id}")
    @PreAuthorize("@pms.hasAnyPermission('allUserGroupPermissions', 'getUserGroupDetail')")
    ...
    @GetMapping("/{id}/users")
    @PreAuthorize("@pms.hasAnyPermission('allUserGroupPermissions', 'getUserGroupUsers')")
    ...
    @PutMapping
    @PreAuthorize("@pms.hasAnyPermission('allUserGroupPermissions', 'updateUserGroup')")
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("@pms.hasAnyPermission('allUserGroupPermissions', 'deleteUserGroup')")
