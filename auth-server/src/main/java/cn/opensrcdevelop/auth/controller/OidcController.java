...
public class OidcController {
    ...
    public void createOidcScope(
            @RequestBody @Validated({ValidationGroups.Operation.INSERT.class}) OidcScopeRequestDto requestDto) {
    ...
    public void createOidcClaim(
            @RequestBody @Validated({ValidationGroups.Operation.INSERT.class}) OidcClaimRequestDto requestDto) {
    ...
    public void updateOidcScope(
            @RequestBody @Validated({ValidationGroups.Operation.UPDATE.class}) OidcScopeRequestDto requestDto) {
    ...
    public void updateOidcClaim(
            @RequestBody @Validated({ValidationGroups.Operation.UPDATE.class}) OidcClaimRequestDto requestDto) {
