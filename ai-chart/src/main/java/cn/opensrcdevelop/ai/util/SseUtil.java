...
public class SseUtil {
     ...
     * @throws IOException IO异常
     */
    public static void sendChatBITextSegmented(SseEmitter emitter, String text, long maxDelay) throws IOException {
        ...
        for (int i = 0; i < segmentCount; i++) {
            ...
            try {
                ...
                throw new IOException("Interrupted while adding delay", e);
            }
        }
    }
     ...
     * @throws IOException IO异常
     */
    public static void sendChatBIDone(SseEmitter emitter, String chartId) throws IOException {
        emitter.send(SseEmitter
                .event()
                .data(ChatBIResponseDto.builder()
