...
public enum ResourceType {
    ...
    CLIENT("75a3dee9-a95f-4ad3-a32a-a7f6d34c0050",
            "客户端"),
    ...
    MESSAGE_SETTING(
            ...
            "消息设置"),
    OIDC_CLAIM("931848a2-beb6-444e-a7d7-72e909553b00",
            "OIDC Claim"),
    OIDC_SCOPE("0f35efeb-3f5a-4e22-84c4-4b4a08b6717c",
            "OIDC Scope"),
    PWD_POLICY("2d2225a8-5143-4465-ab76-06b101abff8f",
            "密码策略"),
    PERMISSION("75c35dc3-1996-48ab-be27-e4078f86a559",
            "权限"),
    PERMISSION_EXP(
            "79a30d3a-0fde-4087-a307-619cc0c56b17",
            "权限表达式"),
    PERMISSION_EXP_TEMPLATE(
