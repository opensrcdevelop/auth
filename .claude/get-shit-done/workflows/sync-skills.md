...
INSTALL_JS_GLOBAL="/Users/lee0407/dev/projs/auth/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/lee0407/dev/projs/auth/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
