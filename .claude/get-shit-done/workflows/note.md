...
- **Global scope**: `/Users/lee0407/dev/projs/auth/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/lee0407/dev/projs/auth/.claude/notes/`)
...
2. Glob `/Users/lee0407/dev/projs/auth/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/lee0407/dev/projs/auth/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/lee0407/dev/projs/auth/.claude/notes/` — works in any directory
