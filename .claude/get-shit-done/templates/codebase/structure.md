...
- Usage: Reference from command with `@/Users/lee0407/dev/projs/auth/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/lee0407/dev/projs/auth/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/lee0407/dev/projs/auth/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
