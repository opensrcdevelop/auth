...
<reference>
@/Users/lee0407/dev/projs/auth/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/lee0407/dev/projs/auth/.claude/get-shit-done/references/user-profiling.md` to load:
