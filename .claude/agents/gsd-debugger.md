...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/lee0407/dev/projs/auth/.claude
                  → checks /Users/lee0407/dev/projs/auth/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/lee0407/dev/projs/auth/.claude/get-shit-done
                  → writes to /Users/lee0407/dev/projs/auth/.claude/get-shit-done/hooks/
...
@/Users/lee0407/dev/projs/auth/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/lee0407/dev/projs/auth/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/Users/lee0407/dev/projs/auth/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/lee0407/dev/projs/auth/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/lee0407/dev/projs/auth/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
