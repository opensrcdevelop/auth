...
Use template from `/Users/lee0407/dev/projs/auth/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/lee0407/dev/projs/auth/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/lee0407/dev/projs/auth/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
