...
public class DbClientRegistrationRepository implements ClientRegistrationRepository {
    ...
    public ClientRegistration findByRegistrationId(String registrationId) {
        IdentitySourceRegistration identitySourceRegistration = identitySourceRegistrationMapper
                .getRegistrationByCode(registrationId);
        if (Objects.isNull(identitySourceRegistration)
                || Boolean.FALSE.equals(identitySourceRegistration.getEnabled())) {
            return null;
        }
