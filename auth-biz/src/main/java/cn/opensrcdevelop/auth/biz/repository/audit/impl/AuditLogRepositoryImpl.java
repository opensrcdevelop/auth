...
public class AuditLogRepositoryImpl implements AuditLogRepository {
     ...
     */
    @Override
    public void searchUserOperationLog(IPage<AuditLog> page, String keyword, Integer operationType,
     ...
     */
    @Override
    public void searchSysOperationLog(IPage<AuditLog> page, String keyword, Integer operationType, String resourceId,
            LocalDateTime startTime, LocalDateTime endTime) {
