...
public class AuditLogServiceImpl extends ServiceImpl<AuditLogMapper, AuditLog> implements AuditLogService {
     ...
     */
    @Override
    public PageData<AuditLogResponseDto> getUserOperationLogs(int page, int size, String keyword, Integer type, LocalDateTime start, LocalDateTime end) {
        // 1. 数据库操作
        ...
        var records = CommonUtil.stream(pageRequest.getRecords()).map(auditLog ->
     ...
     */
    @Override
    public PageData<AuditLogResponseDto> getSysOperationLogs(int page, int size, String keyword, Integer type, String resourceId, LocalDateTime start, LocalDateTime end) {
        // 1. 数据库操作
        Page<AuditLog> pageRequest = new Page<>(page, size);
