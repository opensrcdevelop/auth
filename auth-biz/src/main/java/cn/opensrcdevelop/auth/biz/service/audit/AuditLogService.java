...
public interface AuditLogService extends IService<AuditLog> {
    ...
    PageData<AuditLogResponseDto> getUserOperationLogs(int page, int size, String keyword, Integer type,
            LocalDateTime start, LocalDateTime end);

    PageData<AuditLogResponseDto> getSysOperationLogs(int page, int size, String keyword, Integer type,
