...
public class CommonFieldMetaObjectHandler implements MetaObjectHandler {
    ...
    public void insertFill(MetaObject metaObject) {
        ...
        AuthUtil.getCurrentUsername().ifPresent(
                username -> this.strictInsertFill(metaObject, CommonConstants.CREATE_BY, String.class, username));
    }
    ...
    public void updateFill(MetaObject metaObject) {
        ...
        AuthUtil.getCurrentUsername().ifPresent(
                username -> this.strictUpdateFill(metaObject, CommonConstants.UPDATE_BY, String.class, username));
    }
}
