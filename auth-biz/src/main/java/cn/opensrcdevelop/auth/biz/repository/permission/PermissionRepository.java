...
public interface PermissionRepository {
    ...
    void searchUserGroupPermissions(IPage<AuthorizeRecord> page, String userGroupId,
    ...
    void searchRolePermissions(IPage<AuthorizeRecord> page, String roleId, String resourceGroupNameSearchKeyword,
