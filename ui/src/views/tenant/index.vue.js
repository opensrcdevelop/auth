...
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "tenant-header" }));
...
var __VLS_6;
var __VLS_7 = {
    onClick: (__VLS_ctx.handleToCreateTenant)
};
__VLS_3.slots.default;
var __VLS_3;
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "tenant-search" }));
var __VLS_8 = {}.AInputSearch;
/** @type {[typeof __VLS_components.AInputSearch, typeof __VLS_components.aInputSearch, ]} */ ;
// @ts-ignore
var __VLS_9 = __VLS_asFunctionalComponent(__VLS_8, new __VLS_8(__assign(__assign(__assign(__assign(__assign({ 'onSearch': {} }, { 'onKeyup': {} }), { 'onClear': {} }), { modelValue: (__VLS_ctx.tenantSerachKeyword) }), { style: ({ width: '320px' }) }), { placeholder: "输入租户名称或标识进行搜索", allowClear: true })));
var __VLS_10 = __VLS_9.apply(void 0, __spreadArray([__assign(__assign(__assign(__assign(__assign({ 'onSearch': {} }, { 'onKeyup': {} }), { 'onClear': {} }), { modelValue: (__VLS_ctx.tenantSerachKeyword) }), { style: ({ width: '320px' }) }), { placeholder: "输入租户名称或标识进行搜索", allowClear: true })], __VLS_functionalComponentArgsRest(__VLS_9), false));
var __VLS_12;
var __VLS_13;
var __VLS_14;
var __VLS_15 = {
    onSearch: function () {
        ...
        var $event = _a[0];
        __VLS_ctx.handleGetTenantList(1, 15);
    }
};
var __VLS_16 = {
    onKeyup: function () {
...
var __VLS_11;
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "tenant-list" }));
var __VLS_18 = {}.ATable;
/** @type {[typeof __VLS_components.ATable, typeof __VLS_components.aTable, typeof __VLS_components.ATable, typeof __VLS_components.aTable, ]} */ ;
// @ts-ignore
var __VLS_19 = __VLS_asFunctionalComponent(__VLS_18, new __VLS_18(__assign(__assign({ 'onPageChange': {} }, { 'onPageSizeChange': {} }), { data: (__VLS_ctx.tenantList), bordered: (false), scroll: ({ y: '100%' }), pagination: (__VLS_ctx.tenantPagination.pagination) })));
var __VLS_20 = __VLS_19.apply(void 0, __spreadArray([__assign(__assign({ 'onPageChange': {} }, { 'onPageSizeChange': {} }), { data: (__VLS_ctx.tenantList), bordered: (false), scroll: ({ y: '100%' }), pagination: (__VLS_ctx.tenantPagination.pagination) })], __VLS_functionalComponentArgsRest(__VLS_19), false));
var __VLS_22;
var __VLS_23;
var __VLS_24;
var __VLS_25 = {
    onPageChange: (__VLS_ctx.tenantPagination.handlePageChange)
};
var __VLS_26 = {
    onPageSizeChange: (__VLS_ctx.tenantPagination.handlePageSizeChange)
};
__VLS_21.slots.default;
{
    ...
    __VLS_30.slots.default;
    {
        ...
        __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)(__assign({ onClick: function () {
                ...
                var $event = _a[0];
                __VLS_ctx.handleToTenantDetail(record_1);
        ...
        var __VLS_46;
        {
            ...
            var __VLS_58 = {
                onClick: function () {
                    ...
                    var $event = _a[0];
                    __VLS_ctx.handleDeleteTenant(record_2);
                }
            };
...
var __VLS_21;
/** @type {__VLS_StyleScopedClasses['tenant-header']} */ ;
/** @type {__VLS_StyleScopedClasses['left']} */ ;
/** @type {__VLS_StyleScopedClasses['title']} */ ;
/** @type {__VLS_StyleScopedClasses['info']} */ ;
/** @type {__VLS_StyleScopedClasses['tenant-search']} */ ;
/** @type {__VLS_StyleScopedClasses['tenant-list']} */ ;
/** @type {__VLS_StyleScopedClasses['table-column-tenantname']} */ ;
var __VLS_dollars;
var __VLS_self;
