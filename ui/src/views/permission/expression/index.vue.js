...
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "expression-header" }));
...
var __VLS_6;
var __VLS_7 = {
    onClick: (__VLS_ctx.handleToCreatePermssionExp)
};
...
// @ts-ignore
var __VLS_9 = __VLS_asFunctionalComponent(__VLS_8, new __VLS_8(__assign(__assign(__assign(__assign({ 'onSearch': {} }, { 'onKeyup': {} }), { 'onClear': {} }), { style: ({ width: '320px' }) }), { placeholder: "输入条件名称进行搜索", allowClear: true, modelValue: (__VLS_ctx.permissionExpSearchKeyword) })));
var __VLS_10 = __VLS_9.apply(void 0, __spreadArray([__assign(__assign(__assign(__assign({ 'onSearch': {} }, { 'onKeyup': {} }), { 'onClear': {} }), { style: ({ width: '320px' }) }), { placeholder: "输入条件名称进行搜索", allowClear: true, modelValue: (__VLS_ctx.permissionExpSearchKeyword) })], __VLS_functionalComponentArgsRest(__VLS_9), false));
var __VLS_12;
var __VLS_13;
var __VLS_14;
var __VLS_15 = {
    onSearch: function () {
        ...
        var $event = _a[0];
        __VLS_ctx.handleGetPermissionExpList(1, 15);
    }
};
var __VLS_16 = {
    onKeyup: function () {
...
var __VLS_11;
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "expression-list" }));
var __VLS_18 = {}.ATable;
/** @type {[typeof __VLS_components.ATable, typeof __VLS_components.aTable, typeof __VLS_components.ATable, typeof __VLS_components.aTable, ]} */ ;
// @ts-ignore
var __VLS_19 = __VLS_asFunctionalComponent(__VLS_18, new __VLS_18(__assign(__assign({ 'onPageChange': {} }, { 'onPageSizeChange': {} }), { data: (__VLS_ctx.permissionExpList), bordered: (false), scroll: ({ y: '100%' }), pagination: (__VLS_ctx.permissionExpListPagination.pagination) })));
var __VLS_20 = __VLS_19.apply(void 0, __spreadArray([__assign(__assign({ 'onPageChange': {} }, { 'onPageSizeChange': {} }), { data: (__VLS_ctx.permissionExpList), bordered: (false), scroll: ({ y: '100%' }), pagination: (__VLS_ctx.permissionExpListPagination.pagination) })], __VLS_functionalComponentArgsRest(__VLS_19), false));
var __VLS_22;
var __VLS_23;
var __VLS_24;
var __VLS_25 = {
    onPageChange: (__VLS_ctx.permissionExpListPagination.handlePageChange)
};
var __VLS_26 = {
    onPageSizeChange: (__VLS_ctx.permissionExpListPagination.handlePageSizeChange)
};
__VLS_21.slots.default;
{
    ...
    __VLS_30.slots.default;
    {
        ...
        __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)(__assign({ onClick: function () {
                ...
                var $event = _a[0];
                __VLS_ctx.handleToPermissionExpDetail(record_1);
        ...
        var __VLS_46;
        {
            ...
            var __VLS_58 = {
                onClick: function () {
                    ...
                    var $event = _a[0];
                    __VLS_ctx.handleDeletePermissionExp(record_2);
                }
            };
...
/** @type {__VLS_StyleScopedClasses['expression-list']} */ ;
/** @type {__VLS_StyleScopedClasses['table-column-expressionname']} */ ;
var __VLS_dollars;
var __VLS_self;
