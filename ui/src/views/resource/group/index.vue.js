...
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "resource-group-header" }));
...
var __VLS_6;
var __VLS_7 = {
    onClick: (__VLS_ctx.handleToCreateResourceGroup)
};
...
// @ts-ignore
var __VLS_9 = __VLS_asFunctionalComponent(__VLS_8, new __VLS_8(__assign(__assign(__assign(__assign({ 'onSearch': {} }, { 'onKeyup': {} }), { 'onClear': {} }), { style: ({ width: '320px' }) }), { placeholder: "输入资源组名称或标识进行搜索", allowClear: true, modelValue: (__VLS_ctx.resourceGroupSearchKeyword) })));
var __VLS_10 = __VLS_9.apply(void 0, __spreadArray([__assign(__assign(__assign(__assign({ 'onSearch': {} }, { 'onKeyup': {} }), { 'onClear': {} }), { style: ({ width: '320px' }) }), { placeholder: "输入资源组名称或标识进行搜索", allowClear: true, modelValue: (__VLS_ctx.resourceGroupSearchKeyword) })], __VLS_functionalComponentArgsRest(__VLS_9), false));
var __VLS_12;
var __VLS_13;
var __VLS_14;
var __VLS_15 = {
    onSearch: function () {
        ...
        var $event = _a[0];
        __VLS_ctx.handleGetResourceGroupList(1, 15);
    }
};
var __VLS_16 = {
    onKeyup: function () {
...
var __VLS_11;
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "resource-group-list" }));
var __VLS_18 = {}.ATable;
/** @type {[typeof __VLS_components.ATable, typeof __VLS_components.aTable, typeof __VLS_components.ATable, typeof __VLS_components.aTable, ]} */ ;
// @ts-ignore
var __VLS_19 = __VLS_asFunctionalComponent(__VLS_18, new __VLS_18(__assign(__assign({ 'onPageChange': {} }, { 'onPageSizeChange': {} }), { data: (__VLS_ctx.resourceGroupList), bordered: (false), scroll: ({ y: '100%' }), pagination: (__VLS_ctx.resourceGroupListPagination.pagination) })));
var __VLS_20 = __VLS_19.apply(void 0, __spreadArray([__assign(__assign({ 'onPageChange': {} }, { 'onPageSizeChange': {} }), { data: (__VLS_ctx.resourceGroupList), bordered: (false), scroll: ({ y: '100%' }), pagination: (__VLS_ctx.resourceGroupListPagination.pagination) })], __VLS_functionalComponentArgsRest(__VLS_19), false));
var __VLS_22;
var __VLS_23;
var __VLS_24;
var __VLS_25 = {
    onPageChange: (__VLS_ctx.resourceGroupListPagination.handlePageChange)
};
var __VLS_26 = {
    onPageSizeChange: (__VLS_ctx.resourceGroupListPagination.handlePageSizeChange)
};
__VLS_21.slots.default;
{
    ...
    __VLS_30.slots.default;
    {
        ...
        __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)(__assign({ onClick: function () {
                ...
                var $event = _a[0];
                __VLS_ctx.handleToResourceGroupDetail(record_1);
        ...
        var __VLS_46;
        {
            ...
            var __VLS_58 = {
                onClick: function () {
                    ...
                    var $event = _a[0];
                    __VLS_ctx.handleDeleteResourceGroup(record_2);
                }
            };
...
var __VLS_21;
/** @type {__VLS_StyleScopedClasses['resource-group-header']} */ ;
/** @type {__VLS_StyleScopedClasses['left']} */ ;
/** @type {__VLS_StyleScopedClasses['title']} */ ;
/** @type {__VLS_StyleScopedClasses['info']} */ ;
/** @type {__VLS_StyleScopedClasses['resource-group-list']} */ ;
/** @type {__VLS_StyleScopedClasses['table-column-resourcegroupname']} */ ;
var __VLS_dollars;
var __VLS_self;
