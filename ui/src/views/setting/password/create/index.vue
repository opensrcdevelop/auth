...
<template>
  <div>
    <page-header @back="handleBack">
      <div class="create-title">创建密码策略</div>
      ...
      >
        <a-form-item field="name" label="策略名称">
          <a-input v-model="basicInfoForm.name" placeholder="请输入策略名称" />
        </a-form-item>
      ...
      <a-space>
        <a-button type="primary" @click="handleCreatePasswordPolicyFormSubmit"
          >创建</a-button
        >
        <a-button @click="handleResetCreatePasswordPolicyForm">重置</a-button>
      </a-space>
    </page-header>
