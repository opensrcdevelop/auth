...
var __VLS_18;
var __VLS_19 = {
    onClick: (__VLS_ctx.handleToCreateDictData)
};
...
// @ts-ignore
var __VLS_33 = __VLS_asFunctionalComponent(__VLS_32, new __VLS_32(__assign({ 'onSubmitSuccess': {} }, { model: (__VLS_ctx.dictInfoForm), ref: "dictInfoFormRef", rules: (__VLS_ctx.dictInfoFormRules), layout: "vertical" })));
var __VLS_34 = __VLS_33.apply(void 0, __spreadArray([__assign({ 'onSubmitSuccess': {} }, { model: (__VLS_ctx.dictInfoForm), ref: "dictInfoFormRef", rules: (__VLS_ctx.dictInfoFormRules), layout: "vertical" })], __VLS_functionalComponentArgsRest(__VLS_33), false));
var __VLS_36;
var __VLS_37;
var __VLS_38;
var __VLS_39 = {
    onSubmitSuccess: (__VLS_ctx.handleDictInfoFormSubmit)
};
/** @type {typeof __VLS_ctx.dictInfoFormRef} */ ;
var __VLS_40 = {};
...
var __VLS_55 = __VLS_asFunctionalComponent(__VLS_54, new __VLS_54({
    modelValue: (__VLS_ctx.dictInfoForm.name),
    placeholder: "请输入字典名称",
}));
...
var __VLS_67 = __VLS_asFunctionalComponent(__VLS_66, new __VLS_66({
    modelValue: (__VLS_ctx.dictInfoForm.code),
    placeholder: "请输入字典标识",
}));
...
var __VLS_75 = __VLS_asFunctionalComponent(__VLS_74, new __VLS_74({
    modelValue: (__VLS_ctx.dictInfoForm.desc),
    placeholder: "请输入字典描述",
    autoSize: ({
        minRows: 3,
        maxRows: 5,
...
var __VLS_96;
var __VLS_97 = {
    onClick: (__VLS_ctx.handleResetDictInfoForm)
};
...
// @ts-ignore
var __VLS_103 = __VLS_asFunctionalComponent(__VLS_102, new __VLS_102(__assign(__assign(__assign(__assign(__assign({ 'onSearch': {} }, { 'onKeyup': {} }), { 'onClear': {} }), { modelValue: (__VLS_ctx.dictDataSerachKeyword) }), { style: ({ width: '320px' }) }), { placeholder: "输入数据标签或值进行搜索", allowClear: true })));
var __VLS_104 = __VLS_103.apply(void 0, __spreadArray([__assign(__assign(__assign(__assign(__assign({ 'onSearch': {} }, { 'onKeyup': {} }), { 'onClear': {} }), { modelValue: (__VLS_ctx.dictDataSerachKeyword) }), { style: ({ width: '320px' }) }), { placeholder: "输入数据标签或值进行搜索", allowClear: true })], __VLS_functionalComponentArgsRest(__VLS_103), false));
var __VLS_106;
var __VLS_107;
var __VLS_108;
var __VLS_109 = {
    onSearch: function () {
        ...
        var $event = _a[0];
        __VLS_ctx.handleGetDictDataList();
    }
};
var __VLS_110 = {
    onKeyup: function () {
...
var __VLS_105;
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "dict-data-list" }));
var __VLS_112 = {}.ATable;
/** @type {[typeof __VLS_components.ATable, typeof __VLS_components.aTable, typeof __VLS_components.ATable, typeof __VLS_components.aTable, ]} */ ;
// @ts-ignore
var __VLS_113 = __VLS_asFunctionalComponent(__VLS_112, new __VLS_112(__assign(__assign({ 'onPageChange': {} }, { 'onPageSizeChange': {} }), { data: (__VLS_ctx.dictDataList), bordered: (false), scroll: ({ y: '100%' }), pagination: (__VLS_ctx.dictDataPagination.pagination) })));
var __VLS_114 = __VLS_113.apply(void 0, __spreadArray([__assign(__assign({ 'onPageChange': {} }, { 'onPageSizeChange': {} }), { data: (__VLS_ctx.dictDataList), bordered: (false), scroll: ({ y: '100%' }), pagination: (__VLS_ctx.dictDataPagination.pagination) })], __VLS_functionalComponentArgsRest(__VLS_113), false));
var __VLS_116;
var __VLS_117;
var __VLS_118;
var __VLS_119 = {
    onPageChange: (__VLS_ctx.dictDataPagination.handlePageChange)
};
var __VLS_120 = {
    onPageSizeChange: (__VLS_ctx.dictDataPagination.handlePageSizeChange)
};
__VLS_115.slots.default;
{
    ...
    __VLS_124.slots.default;
    {
        ...
        __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)(__assign({ onClick: function () {
                ...
                var $event = _a[0];
                __VLS_ctx.handleToDictDataDetail(record_1);
    ...
    {
        var __VLS_thisSlot_4 = __VLS_136.slots.cell;
        var record_2 = __VLS_getSlotParams(__VLS_thisSlot_4)[0].record;
        var __VLS_137 = {}.ADropdown;
        ...
        {
            var __VLS_thisSlot_5 = __VLS_144.slots.icon;
            var __VLS_145 = {}.IconMore;
        ...
        var __VLS_144;
        {
            var __VLS_thisSlot_6 = __VLS_140.slots.content;
            var __VLS_149 = {}.ADoption;
            ...
            // @ts-ignore
            var __VLS_150 = __VLS_asFunctionalComponent(__VLS_149, new __VLS_149(__assign({ 'onClick': {} }, { style: {} })));
            var __VLS_151 = __VLS_150.apply(void 0, __spreadArray([__assign({ 'onClick': {} }, { style: {} })], __VLS_functionalComponentArgsRest(__VLS_150), false));
            ...
            var __VLS_156 = {
                onClick: function () {
                    ...
                    var $event = _a[0];
                    __VLS_ctx.handleDeleteDictData(record_2);
                }
            };
            __VLS_152.slots.default;
            {
                var __VLS_thisSlot_7 = __VLS_152.slots.icon;
                var __VLS_157 = {}.IconDelete;
...
/** @type {__VLS_StyleScopedClasses['tab-container']} */ ;
/** @type {__VLS_StyleScopedClasses['dict-data-list']} */ ;
/** @type {__VLS_StyleScopedClasses['table-column-dictdatalabel']} */ ;
// @ts-ignore
