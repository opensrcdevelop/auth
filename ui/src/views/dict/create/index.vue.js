...
// @ts-ignore
var __VLS_9 = __VLS_asFunctionalComponent(__VLS_8, new __VLS_8(__assign({ 'onSubmitSuccess': {} }, { model: (__VLS_ctx.createDictForm), rules: (__VLS_ctx.createDictFormRules), ref: "createDictFormRef", layout: "vertical" })));
var __VLS_10 = __VLS_9.apply(void 0, __spreadArray([__assign({ 'onSubmitSuccess': {} }, { model: (__VLS_ctx.createDictForm), rules: (__VLS_ctx.createDictFormRules), ref: "createDictFormRef", layout: "vertical" })], __VLS_functionalComponentArgsRest(__VLS_9), false));
var __VLS_12;
var __VLS_13;
var __VLS_14;
var __VLS_15 = {
    onSubmitSuccess: (__VLS_ctx.handleCreateDictFormSubmit)
};
/** @type {typeof __VLS_ctx.createDictFormRef} */ ;
var __VLS_16 = {};
...
var __VLS_31 = __VLS_asFunctionalComponent(__VLS_30, new __VLS_30({
    modelValue: (__VLS_ctx.createDictForm.name),
    placeholder: "请输入字典名称",
}));
...
var __VLS_43 = __VLS_asFunctionalComponent(__VLS_42, new __VLS_42({
    modelValue: (__VLS_ctx.createDictForm.code),
    placeholder: "请输入字典标识",
}));
...
var __VLS_51 = __VLS_asFunctionalComponent(__VLS_50, new __VLS_50({
    modelValue: (__VLS_ctx.createDictForm.desc),
    placeholder: "请输入字典描述",
    autoSize: ({
        minRows: 3,
        maxRows: 5,
...
var __VLS_72;
var __VLS_73 = {
    onClick: (__VLS_ctx.handleResetCreateDictForm)
};
