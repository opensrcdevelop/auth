...
var __VLS_11 = {
    onSearch: function () {
        ...
        var $event = _a[0];
        __VLS_ctx.handleGetUserOperationLogs();
    }
};
var __VLS_12 = {
    onClear: function () {
...
// @ts-ignore
var __VLS_14 = __VLS_asFunctionalComponent(__VLS_13, new __VLS_13(__assign(__assign({ 'onChange': {} }, { style: ({ width: '180px' }) }), { placeholder: "操作类型", allowClear: true, modelValue: (__VLS_ctx.operationType) })));
var __VLS_15 = __VLS_14.apply(void 0, __spreadArray([__assign(__assign({ 'onChange': {} }, { style: ({ width: '180px' }) }), { placeholder: "操作类型", allowClear: true, modelValue: (__VLS_ctx.operationType) })], __VLS_functionalComponentArgsRest(__VLS_14), false));
var __VLS_17;
var __VLS_18;
var __VLS_19;
var __VLS_20 = {
...
for (var _i = 0, _c = __VLS_getVForSourceType((__VLS_ctx.operationTypes)); _i < _c.length; _i++) {
...
var __VLS_32;
{
    ...
    for (var _e = 0, _f = __VLS_getVForSourceType((__VLS_ctx.columns)); _e < _f.length; _e++) {
        ...
        // @ts-ignore
        var __VLS_38 = __VLS_asFunctionalComponent(__VLS_37, new __VLS_37(__assign({ style: {} }, { modelValue: (item.visible), disabled: (!item.editable) })));
        var __VLS_39 = __VLS_38.apply(void 0, __spreadArray([__assign({ style: {} }, { modelValue: (item.visible), disabled: (!item.editable) })], __VLS_functionalComponentArgsRest(__VLS_38), false));
...
var __VLS_44;
var __VLS_3;
var __VLS_53 = {}.ARangePicker;
/** @type {[typeof __VLS_components.ARangePicker, typeof __VLS_components.aRangePicker, ]} */ ;
// @ts-ignore
var __VLS_54 = __VLS_asFunctionalComponent(__VLS_53, new __VLS_53(__assign({ 'onChange': {} }, { position: "br", valueFormat: "YYYY-MM-DD HH:mm:ss", disabledDate: (function (current) { return __VLS_ctx.getDayjs(current).isAfter(new Date()); }), shortcuts: ([
        {
            label: '近 7 天',
...
var __VLS_55 = __VLS_54.apply(void 0, __spreadArray([__assign({ 'onChange': {} }, { position: "br", valueFormat: "YYYY-MM-DD HH:mm:ss", disabledDate: (function (current) { return __VLS_ctx.getDayjs(current).isAfter(new Date()); }), shortcuts: ([
            {
                label: '近 7 天',
                value: function () { return [
                    new Date(),
        ...
        ]), modelValue: (__VLS_ctx.dateRange) })], __VLS_functionalComponentArgsRest(__VLS_54), false));
var __VLS_57;
var __VLS_58;
var __VLS_59;
var __VLS_60 = {
...
// @ts-ignore
var __VLS_62 = __VLS_asFunctionalComponent(__VLS_61, new __VLS_61(__assign(__assign({ 'onPageChange': {} }, { 'onPageSizeChange': {} }), { data: (__VLS_ctx.userOperationLogs), bordered: (false), pagination: (__VLS_ctx.userOperationLogsPagination.pagination), scroll: ({ y: '100%' }), expandable: ({ width: 30 }), rowKey: "id" })));
var __VLS_63 = __VLS_62.apply(void 0, __spreadArray([__assign(__assign({ 'onPageChange': {} }, { 'onPageSizeChange': {} }), { data: (__VLS_ctx.userOperationLogs), bordered: (false), pagination: (__VLS_ctx.userOperationLogsPagination.pagination), scroll: ({ y: '100%' }), expandable: ({ width: 30 }), rowKey: "id" })], __VLS_functionalComponentArgsRest(__VLS_62), false));
var __VLS_65;
var __VLS_66;
var __VLS_67;
var __VLS_68 = {
    onPageChange: (__VLS_ctx.userOperationLogsPagination.handlePageChange)
};
var __VLS_69 = {
    onPageSizeChange: (__VLS_ctx.userOperationLogsPagination.handlePageSizeChange)
};
__VLS_64.slots.default;
{
    var __VLS_thisSlot = __VLS_64.slots.columns;
    var _loop_1 = function (column, index) {
        __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
            key: (index),
        });
        if (column.visible) {
            var __VLS_70 = {}.ATableColumn;
            ...
            {
                var __VLS_thisSlot_1 = __VLS_73.slots.cell;
    ...
    var __VLS_77, __VLS_73;
    for (var _h = 0, _j = __VLS_getVForSourceType((__VLS_ctx.columns)); _h < _j.length; _h++) {
        var _k = _j[_h], column = _k[0], index = _k[1];
        _loop_1(column, index);
    }
}
{
    var __VLS_thisSlot = __VLS_64.slots["expand-row"];
    ...
    var __VLS_82 = {}.ADescriptionsItem;
    ...
    (record_2.time);
    var __VLS_85;
    var __VLS_86 = {}.ADescriptionsItem;
    /** @type {[typeof __VLS_components.ADescriptionsItem, typeof __VLS_components.aDescriptionsItem, typeof __VLS_components.ADescriptionsItem, typeof __VLS_components.aDescriptionsItem, ]} */ ;
    // @ts-ignore
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({});
    ((_b = __VLS_ctx.operationTypes.find(function (item) { return item.value === record_2.type; })) === null || _b === void 0 ? void 0 : _b.label);
    var __VLS_89;
    ...
    {
        var __VLS_thisSlot_2 = __VLS_93.slots.label;
        __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({});
        if (record_2.type == 1 && record_2.result) {
            var __VLS_94 = {}.AButton;
            /** @type {[typeof __VLS_components.AButton, typeof __VLS_components.aButton, typeof __VLS_components.AButton, typeof __VLS_components.aButton, ]} */ ;
            // @ts-ignore
            var __VLS_95 = __VLS_asFunctionalComponent(__VLS_94, new __VLS_94(__assign(__assign({ 'onClick': {} }, { type: "text", size: "mini" }), { style: {} })));
            var __VLS_96 = __VLS_95.apply(void 0, __spreadArray([__assign(__assign({ 'onClick': {} }, { type: "text", size: "mini" }), { style: {} })], __VLS_functionalComponentArgsRest(__VLS_95), false));
            var __VLS_98 = void 0;
            var __VLS_99 = void 0;
    ...
    (record_2.userId);
    var __VLS_109;
    var __VLS_110 = {}.ADescriptionsItem;
    /** @type {[typeof __VLS_components.ADescriptionsItem, typeof __VLS_components.aDescriptionsItem, typeof __VLS_components.ADescriptionsItem, typeof __VLS_components.aDescriptionsItem, ]} */ ;
    // @ts-ignore
...
{
    var __VLS_thisSlot = __VLS_64.slots["expand-icon"];
    var expanded = __VLS_getSlotParams(__VLS_thisSlot)[0].expanded;
    if (!expanded) {
        var __VLS_138 = {}.IconRight;
...
var __VLS_64;
var __VLS_146 = {}.AModal;
/** @type {[typeof __VLS_components.AModal, typeof __VLS_components.aModal, typeof __VLS_components.AModal, typeof __VLS_components.aModal, ]} */ ;
// @ts-ignore
var __VLS_147 = __VLS_asFunctionalComponent(__VLS_146, new __VLS_146(__assign({ 'onCancel': {} }, { visible: (__VLS_ctx.objChangesModalVisible), footer: (false), draggable: true, mask: (false), width: (680), modalStyle: ({
        border: '1px solid var(--color-neutral-3)',
    }) })));
var __VLS_148 = __VLS_147.apply(void 0, __spreadArray([__assign({ 'onCancel': {} }, { visible: (__VLS_ctx.objChangesModalVisible), footer: (false), draggable: true, mask: (false), width: (680), modalStyle: ({
            border: '1px solid var(--color-neutral-3)',
...
{
    var __VLS_thisSlot = __VLS_149.slots.title;
}
var __VLS_154 = {}.ATable;
/** @type {[typeof __VLS_components.ATable, typeof __VLS_components.aTable, typeof __VLS_components.ATable, typeof __VLS_components.aTable, ]} */ ;
// @ts-ignore
...
{
    var __VLS_thisSlot = __VLS_157.slots.columns;
    var __VLS_158 = {}.ATableColumn;
    /** @type {[typeof __VLS_components.ATableColumn, typeof __VLS_components.aTableColumn, typeof __VLS_components.ATableColumn, typeof __VLS_components.aTableColumn, ]} */ ;
    // @ts-ignore
    ...
    {
        var __VLS_thisSlot_3 = __VLS_161.slots.cell;
        var rowIndex = __VLS_getSlotParams(__VLS_thisSlot_3)[0].rowIndex;
        __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({});
        (rowIndex + 1);
    }
    var __VLS_161;
    var __VLS_162 = {}.ATableColumn;
    /** @type {[typeof __VLS_components.ATableColumn, typeof __VLS_components.aTableColumn, typeof __VLS_components.ATableColumn, typeof __VLS_components.aTableColumn, ]} */ ;
    // @ts-ignore
    ...
    {
        var __VLS_thisSlot_4 = __VLS_165.slots.cell;
