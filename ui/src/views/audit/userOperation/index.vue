  ...
  <div>
    <div class="log-header">
      <div class="left">
        ...
        <div class="info">对用户操作进行记录，提供审计。</div>
      </div>
    </div>
    <div class="log-filter">
      <a-space>
        <a-input-search
          ...
          allow-clear
          @search="handleGetUserOperationLogs()"
          @clear="handleGetUserOperationLogs()"
        />
        <a-select
          :style="{ width: '180px' }"
          placeholder="操作类型"
          ...
          @change="handleGetUserOperationLogs()"
        >
          <a-option
        ...
        <a-button @click="handleGetUserOperationLogs()">
          <template #icon>
            <icon-refresh />
          </template>
        </a-button>
    ...
    <div class="log-content">
      <a-table
        :data="userOperationLogs"
        :bordered="false"
        :pagination="userOperationLogsPagination.pagination"
        :scroll="{ y: '100%' }"
        :expandable="{ width: 30 }"
        row-key="id"
        @page-change="userOperationLogsPagination.handlePageChange"
        @page-size-change="userOperationLogsPagination.handlePageSizeChange"
      >
        <template #columns>
