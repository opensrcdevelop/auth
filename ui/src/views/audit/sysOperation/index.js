...
// 系统操作日志
var sysOperationLogs = reactive([]);
var sysOperationLogsPagination;
var searchKeyword = ref(null);
var operationType = ref(null);
var resourceType = ref(null);
var dateRange = ref(null);
/**
 * 获取系统操作日志
 */
var handleGetSysOperationLogs = function (page, size) {
    ...
    getSysOperationLogs(params)
        ...
        handleApiSuccess(result, function (data) {
            ...
            sysOperationLogs.push.apply(sysOperationLogs, data.list);
            sysOperationLogsPagination.updatePagination(data.current, data.total, data.size);
        });
    })
        .catch(function (err) {
...
export default defineComponent({
    setup: function () {
        sysOperationLogsPagination = usePagination("sysOperationLogs", function (_a) {
        ...
        return {
            ...
            dateRange: dateRange,
            sysOperationLogs: sysOperationLogs,
            sysOperationLogsPagination: sysOperationLogsPagination,
            getDayjs: getDayjs,
            handleGetSysOperationLogs: handleGetSysOperationLogs,
