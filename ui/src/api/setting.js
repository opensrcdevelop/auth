 ...
 * @returns 邮件模版详情
 */
export function getMailTemplateDetail(id) {
    return apiRequest.get({
        url: "/setting/message/mail/template/".concat(id),
    });
}
/**
 * 更新邮件模版
 ...
 * @returns 响应结果
 */
export function saveMailServiceConfig(data) {
 ...
 * @returns
 */
export function saveMailMessageConfig(data) {
    return apiRequest.post({
        url: "/setting/message/mail/config",
        data: data,
    });
 ...
 * @returns
 */
export function updatePasswordPolicyPriority(data) {
    return apiRequest.put({
 ...
 * @returns 响应结果
 */
export function deletePasswordPolicy(id) {
    return apiRequest.delete({
        url: "/setting/passwordPolicy/".concat(id),
    });
}
/**
 * 获取密码策略详情
 ...
 * @returns 密码策略详情
 */
export function getPasswordPolicyDdetail(id) {
    return apiRequest.get({
        url: "/setting/passwordPolicy/".concat(id),
    });
}
 ...
 * @returns 响应结果
 */
export function checkPasswordWithoutPolicy(data) {
    return noneLoadingApiRequest.post({
 ...
 * @returns 密码策略提醒日志列表
 */
export function getUpdatePasswordRemindLogList(params) {
    return apiRequest.get({
 ...
 * @returns 响应结果
 */
export function saveJwtSecretRotationConfig(data) {
    return apiRequest.post({
        url: "/setting/jwt/secret/rotation/config",
        data: data,
    });
